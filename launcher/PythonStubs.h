...
int DECLARE_PY(PyDict_Check)(PyObject *o);
int DECLARE_PY(PyList_Check)(PyObject *o);
int DECLARE_PY(PySequence_Check)(PyObject *o);
int DECLARE_PY(PyTuple_Check)(PyObject *o);
...
bool DECLARE_PY(PyLong_Check)(PyObject *o);
bool DECLARE_PY(PyModule_Check)(PyObject *o);
bool DECLARE_PY(PyUnicode_Check)(PyObject *o);
